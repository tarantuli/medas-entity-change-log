...
class AfterChangeHandlerTest extends TestCase
{
    ...
    public function testUpdate(): void
    {
        ...
        $changes->addUpdate($task, ['description' => new PropertyChange('Test change log', 'Test change log 2')]);
    ...
    public function testUpdateToLongString(): void
    {
        ...
        $changes->addUpdate($task, ['description' => new PropertyChange($initialDescription, $secondDescreiption)]);
